...
import 'package:flutter_48_xhdq/bean/SecondSwitchBean.dart';
import 'package:flutter_48_xhdq/bean/firstSwitch.dart';
import 'package:flutter_48_xhdq/bean/firstSwitchData.dart';
import 'package:flutter_48_xhdq/http/RequestHelper.dart';
import 'package:flutter_48_xhdq/page/mj_page.dart';
  ...
  void requestSecond() async {
    ...
    RequestHelper.getInstance().getJsonAndHavaHeader(headers, url, (data) {
      ...
      if (secondSwitchBean != null &&
        ...
        SwitchBean switchBean = secondSwitchBean.results[0];
